...
namespace GFOL.Helpers.TagHelpers
{
    public class GfolEnums
    {
        ...
        {
            [Description("govuk-list govuk-list--bullet")]
            Bullet,

            [Description("govuk-list govuk-!-font-size-16")]
            Normal
        }

        public enum FieldsetTypes
        {
            [Description("govuk-fieldset col-8")]
            NormalCol8,

            [Description("govuk-fieldset")]
            Normal
        }
